...
const Chat = (props) => {
  ...
  return (
    <div
      id="chat-container"
      className="m-5 py-3 px-4 bg-black border border-white rounded-3 d-flex flex-column"
      style={{
        width: "400px",
        height: "600px",
            ...
            <div
              className={`p-2 rounded-3  ${
                myMsg
                  ...
                  : "align-self-start me-5 bg-success"
              }`}
              key={index}
            >
              <div id="message-author" className="fw-bold gap-3">
                {message.author}
              </div>
